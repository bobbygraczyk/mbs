...
class Nav extends React.Component {
    constructor(props) {
        ...
        this.navButtons = (
            <React.Fragment>
                <NavLink className="nav-link" to='/home' activeStyle={this.navActiveStyle}>Home</NavLink>
                <NavLink className="nav-link" to='/about' activeStyle={this.navActiveStyle}>About</NavLink>
            </React.Fragment>);
        this.state = {
            navOpen: false
        }
