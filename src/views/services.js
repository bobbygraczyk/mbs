        ...
        return (
            <div className="services">
                ...
                <div className="frame appts">
                    ...
                    <div className="appt-type col-30 drop-shadow">
                        <h3>New Patient Exam</h3>
                        <span className="subhead">(30 - 35 minutes)</span>
                        <ul>
                    ...
                    <div className="appt-type col-30 drop-shadow">
                        ...
                        <span className="subhead">(20 minutes)</span>
                        <ul>
                    ...
                    <div className="appt-type col-30 drop-shadow">
                        ...
                        <span className="subhead">(10 - 15 minutes)</span>
                        <ul>
                            <li>A routine visit will be based on the findings of the patient’s new patient exam. All findings will be thoroughly evaluated by the doctor, and the doctor will make the recommended treatment plan catered toward the patient’s specific needs. The doctor will go over all findings and recommendations with the patient before beginning the treatment plan.</li>
                        </ul>
                    </div>
                </div>
